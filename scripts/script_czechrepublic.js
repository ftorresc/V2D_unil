...
const pragueLonLat = [14.4207, 50.0880]


const geoInterpolator1 = d3.geoInterpolate(pragueLonLat, glasgowLonLat);
const geoInterpolator2 = d3.geoInterpolate(glasgowLonLat, pragueLonLat);
const geoInterpolator3 = d3.geoInterpolate(pragueLonLat, londonLonLat);
const geoInterpolator4 = d3.geoInterpolate(londonLonLat, pragueLonLat);
const geoInterpolator5 = d3.geoInterpolate(pragueLonLat, budapestLonLat);
const geoInterpolator6 = d3.geoInterpolate(budapestLonLat, pragueLonLat);
const geoInterpolator7 = d3.geoInterpolate(pragueLonLat, bakuLonLat);
...
function update() {
  ...
  geoGenerator({type: 'Feature', geometry: {type: 'LineString', coordinates: [glasgowLonLat, pragueLonLat]}});
  context.stroke();

  context.beginPath();
  context.strokeStyle = 'red';
  geoGenerator({type: 'Feature', geometry: {type: 'LineString', coordinates: [londonLonLat, pragueLonLat]}});
  context.stroke();

  context.beginPath();
  context.strokeStyle = 'red';
  geoGenerator({type: 'Feature', geometry: {type: 'LineString', coordinates: [pragueLonLat, budapestLonLat]}});
  context.stroke();

  context.beginPath();
  context.strokeStyle = 'red';
  geoGenerator({type: 'Feature', geometry: {type: 'LineString', coordinates: [pragueLonLat, bakuLonLat]}});
  context.stroke();

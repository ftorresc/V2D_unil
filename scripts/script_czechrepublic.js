...
const geoInterpolator1 = d3.geoInterpolate(glasgowLonLat, londonLonLat);
const geoInterpolator2 = d3.geoInterpolate(londonLonLat, budapestLonLat);
const geoInterpolator3 = d3.geoInterpolate(budapestLonLat, bakuLonLat);
...
function update() {
  ...
  geoGenerator({type: 'Feature', geometry: {type: 'LineString', coordinates: [glasgowLonLat, londonLonLat]}});
  context.stroke();

  context.beginPath();
  context.strokeStyle = 'red';
  geoGenerator({type: 'Feature', geometry: {type: 'LineString', coordinates: [londonLonLat, budapestLonLat]}});
  context.stroke();

  context.beginPath();
  context.strokeStyle = 'red';
  geoGenerator({type: 'Feature', geometry: {type: 'LineString', coordinates: [budapestLonLat, bakuLonLat]}});
  context.stroke();

...
const geoInterpolator1 = d3.geoInterpolate(sevilleLonLat, copenhagenLonLat);
const geoInterpolator2 = d3.geoInterpolate(copenhagenLonLat, stpetersburgLonLat);
const geoInterpolator3 = d3.geoInterpolate(stpetersburgLonLat, londonLonLat);
...
function update() {
  ...
  geoGenerator({type: 'Feature', geometry: {type: 'LineString', coordinates: [sevilleLonLat, copenhagenLonLat]}});
  context.stroke();
  ...
  context.beginPath();
  context.strokeStyle = 'red';
  geoGenerator({type: 'Feature', geometry: {type: 'LineString', coordinates: [stpetersburgLonLat, londonLonLat]}});
  context.stroke();

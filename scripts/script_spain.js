...
const rozasLonLat = [-3.8737, 40.4929]


const geoInterpolator1 = d3.geoInterpolate(sevilleLonLat, rozasLonLat);
const geoInterpolator2 = d3.geoInterpolate(rozasLonLat, sevilleLonLat);
const geoInterpolator3 = d3.geoInterpolate(copenhagenLonLat, rozasLonLat);
const geoInterpolator4 = d3.geoInterpolate(rozasLonLat, copenhagenLonLat);
const geoInterpolator5 = d3.geoInterpolate(rozasLonLat, stpetersburgLonLat);
const geoInterpolator6 = d3.geoInterpolate(stpetersburgLonLat, rozasLonLat);
const geoInterpolator7 = d3.geoInterpolate(rozasLonLat, londonLonLat);
...
function update() {
  ...
  geoGenerator({type: 'Feature', geometry: {type: 'LineString', coordinates: [rozasLonLat, sevilleLonLat]}});
  context.stroke();

  context.beginPath();
  context.strokeStyle = 'red';
  geoGenerator({type: 'Feature', geometry: {type: 'LineString', coordinates: [copenhagenLonLat, rozasLonLat]}});
  context.stroke();

  context.beginPath();
  context.strokeStyle = 'red';
  geoGenerator({type: 'Feature', geometry: {type: 'LineString', coordinates: [rozasLonLat, stpetersburgLonLat]}});
  context.stroke();

  context.beginPath();
  context.strokeStyle = 'red';
  geoGenerator({type: 'Feature', geometry: {type: 'LineString', coordinates: [rozasLonLat,londonLonLat]}});
  context.stroke();

...
const geoInterpolator = d3.geoInterpolate(amsterdamLonLat, budapestLonLat);
let u = 0;
...
function update() {
  ...
  geoGenerator({type: 'Feature', geometry: {type: 'LineString', coordinates: [amsterdamLonLat, budapestLonLat]}});
  context.stroke();

...
const telkiLonLat = [18.8333, 47.5499];


const geoInterpolator1 = d3.geoInterpolate(telkiLonLat,budapestLonLat);
const geoInterpolator2 = d3.geoInterpolate(budapestLonLat,telkiLonLat);
const geoInterpolator3 = d3.geoInterpolate(telkiLonLat,budapestLonLat);
const geoInterpolator4 = d3.geoInterpolate(budapestLonLat,telkiLonLat);
const geoInterpolator5 = d3.geoInterpolate(telkiLonLat,munichLonLat);
...
function update() {
  ...
  geoGenerator({type: 'Feature', geometry: {type: 'LineString', coordinates: [telkiLonLat, budapestLonLat]}});
  context.stroke();

  context.beginPath();
  context.strokeStyle = 'red';
  geoGenerator({type: 'Feature', geometry: {type: 'LineString', coordinates: [budapestLonLat, telkiLonLat]}});
  context.stroke();
  ...
  context.beginPath();
  context.strokeStyle = 'red';
  geoGenerator({type: 'Feature', geometry: {type: 'LineString', coordinates: [telkiLonLat, munichLonLat]}});
  context.stroke();

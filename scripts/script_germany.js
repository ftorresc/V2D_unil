...
const geoInterpolator1 = d3.geoInterpolate(munichLonLat, londonLonLat);
...
function update() {
  ...
  geoGenerator({type: 'Feature', geometry: {type: 'LineString', coordinates: [munichLonLat, londonLonLat]}});
  context.stroke();

...
const geoInterpolator = d3.geoInterpolate(romeLonLat, londonLonLat);
const geoInterpolator2 = d3.geoInterpolate(londonLonLat, munichLonLat);
const geoInterpolator3 = d3.geoInterpolate(munichLonLat, londonLonLat);
let u = 0;

...
const geoInterpolator3 = d3.geoInterpolate(bakuLonLat, amsterdamLonLat);
let u = 0;
...
function update() {
  ...
  context.beginPath();
  context.strokeStyle = 'red';
  geoGenerator({type: 'Feature', geometry: {type: 'LineString', coordinates: [bakuLonLat, amsterdamLonLat]}});
  context.stroke();
